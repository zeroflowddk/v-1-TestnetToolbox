...
export type GetContractEventsReturnType<TAbi extends Abi | readonly unknown[] = readonly unknown[], TEventName extends string | undefined = string | undefined, TStrict extends boolean | undefined = undefined, TFromBlock extends BlockNumber | BlockTag | undefined = undefined, TToBlock extends BlockNumber | BlockTag | undefined = undefined, _Pending extends boolean = (TFromBlock extends 'pending' ? true : false) | (TToBlock extends 'pending' ? true : false)> = Log<bigint, number, _Pending, undefined, TStrict, TAbi, TEventName>[];
/**
